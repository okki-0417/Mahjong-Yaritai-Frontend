...
import ProblemUpdateFormModal from "@/src/features/what-to-discard-problems/components/ProblemUpdateFormModal";
...
export default function ProblemCardHeader({
  ...
  return (
    <HStack justifyContent="space-between">
      ...
      <UserModal user={problem.user} isOpen={isUserModalOpen} onClose={onUserModalClose} />
    </HStack>
  );
}
