...
export default function Pagination({ pagination }: { pagination: PaginationType | null }) {
	...
	return (
		<div className="flex gap-1 items-center justify-center w-full font-sans">
			...
			<div className="flex items-center h-10">
				...
				{pagination.prev_page && pagination.prev_page - 1 > pagination.first_page && (
				...
				{pagination.next_page != pagination.last_page && (
					<Link className="w-10 flex justify-center" to={`?page=${pagination.next_page}`}>
						{pagination.next_page}
					</Link>
				)}

				{pagination.next_page && pagination.next_page + 1 < pagination.last_page && (
					<div className="flex items-end">
						<span>...</span>
					</div>
				)}
