    ...
    <div>
      ...
      <section className="mt-24 md:px-[20vw] px-6 text-slate-100">
        ...
        <div className="mt-8 sm:text-xl leading-loose">
          <p>ここは、麻雀を愛する人たちが集まり、繋がれる場所です。</p>
          <p className="mt-4">
      ...
      <section className="mt-24 md:px-[20vw] px-6 text-slate-100">
        ...
        <div className="mt-8 leading-loose">
          <p ref={ref} className="sm:text-xl">
          ...
          <ul className="mt-4 grid sm:grid-cols-2 grid-cols-1 gap-2 sm:text-[clamp(16px,2vw,20px)]">
            <Link
              ...
              className="col-span1 py-5 px-4 border border-blue-700 hover:underline bg-slate-100 text-blue-700 rounded-sm"
            >
            ...
            <li className="col-span-1 py-5 px-4 border border-blue-700 hover:underline bg-slate-100 text-blue-700 rounded-sm">
              <span className="flex items-center gap-4 relative">
                ...
                <FaAngleRight />
                <span className="w-full absolute top-1/2 left-0 -translate-y-1/2 text-2xl text-center text-gray-800 font-bold bg-[rgba(241,245,249,0.5)]">
                  Coming Soon...
                </span>
              </span>
            </li>
            <li className="col-span-1 py-5 px-4 border border-blue-700 hover:underline bg-slate-100 text-blue-700 rounded-sm">
              <span className="flex items-center gap-4 relative">
                ...
                <FaAngleRight />
                <p className="w-full absolute top-1/2 left-0 -translate-y-1/2 text-2xl text-center text-gray-800 font-bold bg-[rgba(241,245,249,0.5)]">
                  Coming Soon...
                </p>
              </span>
            </li>
