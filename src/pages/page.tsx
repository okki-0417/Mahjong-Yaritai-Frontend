  ...
  return (
    <div>
      ...
      <section className="mt-24 md:px-[20vw] px-6 text-slate-100">
        ...
        <div className="mt-8 sm:text-xl">
          <p>
            ｢麻雀ヤリタイ｣ は、麻雀を愛する人たちが集まり、繋がれる場所です。
          </p>
          <p className="mt-4">
      ...
      <section className="lg:mt-20 mt-12 md:px-[20vw] px-6 text-slate-100">
        <h2 className="text-5xl font-bold">
          はじめる
        </h2>
        ...
        <div className="mt-8 leading-loose">
          <ul className="mt-4 grid sm:grid-cols-2 grid-cols-1 gap-4 sm:text-[clamp(16px,2vw,20px)]">
            <Link to="/what-to-discard-problems" className="rounded-semi hover:underline transition-all border-2 border-white">
