  ...
  useEffect(() => {
    const getTileImagePaths = async () => {
      const paths = await Promise.all(
        Array(TILE_TYPES_NUM)
          .fill(null)
          .map(async (_, index) => `/tiles/${index + 1}.png`),
      );
  ...
  return (
    <div className="lg:w-4/5 mx-auto">
      <form onSubmit={handleSubmit(onSubmit)}>
        <h1 className="mt-8 lg:text-4xl text-2xl text-center">
          何切る問題を作る
        </h1>
        ...
        <div className="flex flex-col justify-between mt-8 min-h-40 bg-green-700 text-white rounded-md px-4 py-2">
          <div>
            ...
            <div className="md:text-2xl text-lg md:flex grid grid-cols-2 md:gap-4">
              <span>
                {watch("point_east")
                  ? `東家:${watch("point_east")}00点`
                  : "東家25000点"}
              </span>
              <span>
                {watch("point_south")
                  ? `南家:${watch("point_south")}00点`
                  : "南家25000点"}
              </span>
              <span>
                {watch("point_west")
                  ? `西家:${watch("point_west")}00点`
                  : "西家25000点"}
              </span>
              <span>
                {watch("point_north")
                  ? `北家:${watch("point_north")}00点`
                  : "北家25000点"}
              </span>
            </div>
          </div>
                ...
                return (
                  <div key={index} className="w-12">
                    {watch(`hand${index + 1}` as HandKeys) &&
                      drawTile(watch(`hand${index + 1}` as HandKeys))}
                  </div>
                );
              })}
          ...
          <div className="flex md:flex-row flex-col gap-8 text-2xl mt-2">
            ...
            <div className="flex gap-2 text-2xl">
              ...
              <div className="w-full">
                {
                  <select
                    className="text-gray-800 border border-gray-800 md:w-fit w-10/12 text-center"
                    defaultValue=""
                    {...register("dora", { required: true })}
                  >
          ...
          <div className="mt-6 grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-6">
            <div className="flex gap-2 text-2xl mt-6">
              ...
              <input
                ...
                defaultValue="250"
                max="1500"
                {...register("point_east", { required: true })}
              />
              <span>00点</span>
            </div>
            ...
            <div className="flex gap-2 text-2xl mt-6">
              ...
              <input
                ...
                defaultValue="250"
                max="1500"
                {...register("point_south", { required: true })}
              />
              <span>00点</span>
            </div>
            ...
            <div className="flex gap-2 text-2xl mt-6">
              ...
              <input
                ...
                defaultValue="250"
                max="1500"
                {...register("point_west", { required: true })}
              />
              <span>00点</span>
            </div>
            ...
            <div className="flex gap-2 text-2xl mt-6">
              ...
              <input
                ...
                defaultValue="250"
                max="1500"
                {...register("point_north", { required: true })}
              />
              <span>00点</span>
            </div>
          </div>
        ...
        <section>
          ...
          <div className="mt-2 text-xl text-red-400">
            {(errors.hand1 ||
              ...
              errors.hand12 ||
              errors.hand13 ||
              errors.tsumo) && <span>※手牌情報を全て入力してください</span>}
          </div>
              ...
              .map((_, index) => {
                return (
                  <div key={index} className="flex flex-col items-center">
                    ...
                    <select
                      className="text-gray-800 text-2xl border border-gray-800"
                      defaultValue=""
