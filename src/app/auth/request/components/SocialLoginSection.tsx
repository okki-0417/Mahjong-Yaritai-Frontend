...
export default function SocialLoginSection() {
  ...
  return (
    <VStack w="full" align="stretch" spacing="2">
      ...
      <Text fontSize="sm">
        <Link href="/terms" prefetch={false} className="text-blue-200 underline" target="_blank">
          利用規約
        </Link>
        と
        <Link href="/privacy" prefetch={false} className="text-blue-200 underline" target="_blank">
          プライバシーポリシー
        </Link>
